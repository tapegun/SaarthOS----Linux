...
#define GET_BIT(data, n) ((data) & (1 << (n))) >> (n)
...
/* make it possible to other files to call this function */
/* increments video memory to test RTC */
extern void test_interrupts(void);
extern int32_t set_cursor_position(int32_t x, int32_t y);
extern int get_cursor_y();
extern int get_cursor_x();
extern void scroll_one_unit_down();
void backspace();
/* Port read functions */
